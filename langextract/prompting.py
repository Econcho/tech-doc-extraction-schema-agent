...
class PromptBuildResult:
  """Prompt build output plus the runtime-observable input parts."""
...
class QAPromptGenerator:
  ...
  def render(self, question: str, additional_context: str | None = None) -> str:
    ...
    拼接template.description，additional_context，examples_heading，template.examples，question
...
class PromptBuilder:
  ...
  def build_prompt(
    ...
    return self.build_prompt_parts(
        chunk_text,
        document_id,
        additional_context,
    ).prompt
  ...
  def build_prompt_parts(
    ...
    """Build a prompt and return the runtime-observable parts."""
    del document_id  # Unused in base class.
...
class ContextAwarePromptBuilder(PromptBuilder):
  ...
  def build_prompt_parts(
    ...
    """Build a prompt and return effective runtime-observable parts."""
